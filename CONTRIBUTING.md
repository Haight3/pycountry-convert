...
7. Merging to `master` builds and verifies the distribution, then creates the Git tag and GitHub Release.

The public PyPI project is not modified by this repository's release workflow.
